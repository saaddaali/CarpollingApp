package ma.zyn.app.utils.security.ws.facade;

import jakarta.validation.Valid;

import ma.zyn.app.utils.security.bean.User;
import ma.zyn.app.utils.security.common.SecurityParams;
import ma.zyn.app.utils.security.dao.facade.core.RoleDao;
import ma.zyn.app.utils.security.payload.request.ActivationRequest;
import ma.zyn.app.utils.security.service.facade.UserService;
import ma.zyn.app.utils.security.ws.dto.UserDto;
import ma.zyn.app.utils.security.ws.converter.UserConverter;

import ma.zyn.app.utils.security.jwt.JwtUtils;
import ma.zyn.app.utils.security.payload.request.LoginRequest;
import ma.zyn.app.utils.security.payload.response.JwtResponse;
...
import ma.zyn.app.utils.security.service.facade.LoginAttemptService;
...
public class AuthController {
    ...
    public ResponseEntity<Map<String, String>> registerDriver(@RequestBody UserDto userDto) {
        return register(userDto, AuthoritiesConstants.DRIVER);
    }
    @PostMapping("register/passenger")
    public ResponseEntity<Map<String, String>> registerPassenger(@RequestBody UserDto userDto) {
        return register(userDto, AuthoritiesConstants.PASSENGER);
    }
    ...
    private ResponseEntity<Map<String, String>> register(UserDto userDto, String roleUsers) {
        ...
        Role loadedRoleByAutority = roleRepository.findByAuthority(roleUsers);
        roleUser.setRole(loadedRoleByAutority);
