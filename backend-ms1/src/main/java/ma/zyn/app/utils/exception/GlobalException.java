package ma.zyn.app.utils.exception;

import ma.zyn.app.utils.security.bean.User;
import ma.zyn.app.utils.util.Utils;
...
public class GlobalException extends Exception implements Serializable {
    ...
    public GlobalException(Exception e, MessageSource messageSource, String requestURI) {
        ...
        if (e instanceof ClientAbortException) {
            ...
            System.out.println(Utils.DEFAULT_APP_NAME + " : ClientAbortException : " + requestURI + " : user : " + currentUser.getUsername());
            ...
            if (ex != null) {
                ...
                status = HttpStatus.INTERNAL_SERVER_ERROR;
                User currentUser = (User) SecurityContextHolder.getContext().getAuthentication().getPrincipal();
                System.out.println(Utils.DEFAULT_APP_NAME + " : " + requestURI + " : " + "user : " + currentUser.getUsername());
                e.printStackTrace();
            }
        }
