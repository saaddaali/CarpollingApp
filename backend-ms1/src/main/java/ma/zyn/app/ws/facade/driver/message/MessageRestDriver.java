...
public class MessageRestDriver {
   ...
   public MessageRestDriver(MessageDriverService service, MessageConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final MessageDriverService service;
