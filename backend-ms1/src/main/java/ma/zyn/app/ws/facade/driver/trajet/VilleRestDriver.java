...
@RestController
@RequestMapping("/api/driver/ville/")
public class VilleRestDriver {
   ...
   public VilleRestDriver(VilleDriverService service, VilleConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final VilleDriverService service;
