package  ma.zyn.app.ws.facade.passenger.passenger;
...
public class PassengerRestPassenger {
   ...
   public PassengerRestPassenger(PassengerPassengerService service, PassengerConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final PassengerPassengerService service;
