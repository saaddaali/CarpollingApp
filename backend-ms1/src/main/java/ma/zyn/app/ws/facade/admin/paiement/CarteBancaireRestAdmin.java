package  ma.zyn.app.ws.facade.admin.paiement;
...
@RestController
@RequestMapping("/api/admin/carteBancaire/")
public class CarteBancaireRestAdmin {
   ...
   public CarteBancaireRestAdmin(CarteBancaireAdminService service, CarteBancaireConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final CarteBancaireAdminService service;
