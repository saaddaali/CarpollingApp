package  ma.zyn.app.ws.facade.driver.message;
...
@RestController
@RequestMapping("/api/driver/conversation/")
public class ConversationRestDriver {
   ...
   public ConversationRestDriver(ConversationDriverService service, ConversationConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final ConversationDriverService service;
