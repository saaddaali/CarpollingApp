package  ma.zyn.app.ws.facade.driver.driver;
...
public class DriverRestDriver {
   ...
   public DriverRestDriver(DriverDriverService service, DriverConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final DriverDriverService service;
