package  ma.zyn.app.ws.facade.admin.vehicule;
...
public class VehiculeRestAdmin {
   ...
   public VehiculeRestAdmin(VehiculeAdminService service, VehiculeConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final VehiculeAdminService service;
