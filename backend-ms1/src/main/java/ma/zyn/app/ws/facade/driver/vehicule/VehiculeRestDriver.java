package  ma.zyn.app.ws.facade.driver.vehicule;
...
import ma.zyn.app.service.facade.driver.vehicule.VehiculeDriverService;
...
@RestController
@RequestMapping("/api/driver/vehicule/")
public class VehiculeRestDriver {
   ...
   public VehiculeRestDriver(VehiculeDriverService service, VehiculeConverter converter){
