...
@RestController
@RequestMapping("/api/admin/trajet/")
public class TrajetRestAdmin {
   ...
   public TrajetRestAdmin(TrajetAdminService service, TrajetConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final TrajetAdminService service;
