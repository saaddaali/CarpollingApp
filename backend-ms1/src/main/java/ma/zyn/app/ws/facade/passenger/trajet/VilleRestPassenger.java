...
@RestController
@RequestMapping("/api/passenger/ville/")
public class VilleRestPassenger {
   ...
   public VilleRestPassenger(VillePassengerService service, VilleConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final VillePassengerService service;
