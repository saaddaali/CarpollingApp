package  ma.zyn.app.ws.facade.driver.passenger;
...
public class PassengerRestDriver {
   ...
   public PassengerRestDriver(PassengerDriverService service, PassengerConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final PassengerDriverService service;
