package ma.zyn.app.service.impl.admin.paiement;
...
@Service
public class CarteBancaireAdminServiceImpl implements CarteBancaireAdminService {
    ...
    public CarteBancaireAdminServiceImpl(CarteBancaireDao dao) {
        this.dao = dao;
    }
