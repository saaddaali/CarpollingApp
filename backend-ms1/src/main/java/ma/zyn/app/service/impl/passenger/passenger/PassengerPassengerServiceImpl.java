package ma.zyn.app.service.impl.passenger.passenger;
...
@Service
public class PassengerPassengerServiceImpl implements PassengerPassengerService {
    ...
    public PassengerPassengerServiceImpl(PassengerDao dao) {
        this.dao = dao;
    }
