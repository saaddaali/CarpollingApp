package ma.zyn.app.service.impl.driver.vehicule;
...
import java.util.List;
@Service
public class VehiculeDriverServiceImpl implements VehiculeDriverService {
    ...
    public VehiculeDriverServiceImpl(VehiculeDao dao) {
        this.dao = dao;
    }
