...
@Service
public class TrajetDriverServiceImpl implements TrajetDriverService {
    ...
    @Autowired
    private VilleDriverService villeService ;

    public TrajetDriverServiceImpl(TrajetDao dao) {
        this.dao = dao;
    }
