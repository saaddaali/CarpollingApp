package ma.zyn.app.service.impl.passenger.vehicule;
...
import java.util.List;
@Service
public class VehiculePassengerServiceImpl implements VehiculePassengerService {
    ...
    public VehiculePassengerServiceImpl(VehiculeDao dao) {
        this.dao = dao;
    }
