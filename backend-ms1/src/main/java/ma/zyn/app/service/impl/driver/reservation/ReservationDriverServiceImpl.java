package ma.zyn.app.service.impl.driver.reservation;
...
@Service
public class ReservationDriverServiceImpl implements ReservationDriverService {
    ...
    public ReservationDriverServiceImpl(ReservationDao dao) {
        this.dao = dao;
    }
