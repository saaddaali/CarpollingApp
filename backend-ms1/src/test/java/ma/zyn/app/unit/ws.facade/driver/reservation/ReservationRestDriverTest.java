package ma.zyn.app.unit.ws.facade.driver.reservation;

import ma.zyn.app.bean.core.reservation.Reservation;
import ma.zyn.app.service.impl.driver.reservation.ReservationDriverServiceImpl;
import ma.zyn.app.ws.facade.driver.reservation.ReservationRestDriver;
...
public class ReservationRestDriverTest {

    private MockMvc mockMvc;

    @Mock
    private ReservationDriverServiceImpl service;
    @Mock
    private ReservationConverter converter;

    @InjectMocks
    private ReservationRestDriver controller;
