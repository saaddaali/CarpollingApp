package ma.zyn.app.unit.ws.facade.passenger.paiement;
...
import ma.zyn.app.ws.facade.passenger.paiement.CarteBancaireRestPassenger;
...
public class CarteBancaireRestPassengerTest {

    private MockMvc mockMvc;

    @Mock
    private CarteBancairePassengerServiceImpl service;
    @Mock
    private CarteBancaireConverter converter;

    @InjectMocks
    private CarteBancaireRestPassenger controller;
