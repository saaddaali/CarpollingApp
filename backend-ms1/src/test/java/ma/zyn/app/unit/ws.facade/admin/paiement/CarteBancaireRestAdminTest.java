package ma.zyn.app.unit.ws.facade.admin.paiement;

import ma.zyn.app.bean.core.paiement.CarteBancaire;
import ma.zyn.app.service.impl.admin.paiement.CarteBancaireAdminServiceImpl;
import ma.zyn.app.ws.facade.admin.paiement.CarteBancaireRestAdmin;
...
public class CarteBancaireRestAdminTest {

    private MockMvc mockMvc;

    @Mock
    private CarteBancaireAdminServiceImpl service;
    @Mock
    private CarteBancaireConverter converter;

    @InjectMocks
    private CarteBancaireRestAdmin controller;
