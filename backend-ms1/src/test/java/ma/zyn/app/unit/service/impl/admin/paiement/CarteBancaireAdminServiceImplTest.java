package ma.zyn.app.unit.service.impl.admin.paiement;
...
@SpringBootTest
class CarteBancaireAdminServiceImplTest {

    @Mock
    private CarteBancaireDao repository;
    private AutoCloseable autoCloseable;
    private CarteBancaireAdminServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new CarteBancaireAdminServiceImpl(repository);
    }
