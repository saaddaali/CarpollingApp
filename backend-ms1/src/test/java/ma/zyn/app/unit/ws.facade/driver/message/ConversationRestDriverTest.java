package ma.zyn.app.unit.ws.facade.driver.message;

import ma.zyn.app.bean.core.message.Conversation;
import ma.zyn.app.service.impl.driver.message.ConversationDriverServiceImpl;
import ma.zyn.app.ws.facade.driver.message.ConversationRestDriver;
...
public class ConversationRestDriverTest {

    private MockMvc mockMvc;

    @Mock
    private ConversationDriverServiceImpl service;
    @Mock
    private ConversationConverter converter;

    @InjectMocks
    private ConversationRestDriver controller;
