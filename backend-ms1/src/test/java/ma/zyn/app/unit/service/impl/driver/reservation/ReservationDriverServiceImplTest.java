package ma.zyn.app.unit.service.impl.driver.reservation;
...
@SpringBootTest
class ReservationDriverServiceImplTest {

    @Mock
    private ReservationDao repository;
    private AutoCloseable autoCloseable;
    private ReservationDriverServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new ReservationDriverServiceImpl(repository);
    }
