...
import ma.zyn.app.service.impl.admin.message.MessageAdminServiceImpl;
import ma.zyn.app.ws.facade.admin.message.MessageRestAdmin;
...
public class MessageRestAdminTest {

    private MockMvc mockMvc;

    @Mock
    private MessageAdminServiceImpl service;
    @Mock
    private MessageConverter converter;

    @InjectMocks
    private MessageRestAdmin controller;
