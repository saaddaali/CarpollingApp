package ma.zyn.app.unit.ws.facade.admin.trajet;

import ma.zyn.app.bean.core.trajet.Trajet;
import ma.zyn.app.service.impl.admin.trajet.TrajetAdminServiceImpl;
import ma.zyn.app.ws.facade.admin.trajet.TrajetRestAdmin;
...
public class TrajetRestAdminTest {

    private MockMvc mockMvc;

    @Mock
    private TrajetAdminServiceImpl service;
    @Mock
    private TrajetConverter converter;

    @InjectMocks
    private TrajetRestAdmin controller;
