package ma.zyn.app.unit.service.impl.passenger.trajet;
...
@SpringBootTest
class TrajetPassengerServiceImplTest {

    @Mock
    private TrajetDao repository;
    private AutoCloseable autoCloseable;
    private TrajetPassengerServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new TrajetPassengerServiceImpl(repository);
    }
