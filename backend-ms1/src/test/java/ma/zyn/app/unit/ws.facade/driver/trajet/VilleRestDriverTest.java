...
import ma.zyn.app.ws.facade.driver.trajet.VilleRestDriver;
...
public class VilleRestDriverTest {

    private MockMvc mockMvc;

    @Mock
    private VilleDriverServiceImpl service;
    @Mock
    private VilleConverter converter;

    @InjectMocks
    private VilleRestDriver controller;
