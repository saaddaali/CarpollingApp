...
public class VehiculeRestDriverTest {

    private MockMvc mockMvc;

    @Mock
    private VehiculeDriverServiceImpl service;
    @Mock
    private VehiculeConverter converter;

    @InjectMocks
    private VehiculeRestDriver controller;
