...
public class TrajetRestDriverTest {

    private MockMvc mockMvc;

    @Mock
    private TrajetDriverServiceImpl service;
    @Mock
    private TrajetConverter converter;

    @InjectMocks
    private TrajetRestDriver controller;
