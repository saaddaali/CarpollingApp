package ma.zyn.app.unit.service.impl.driver.driver;
...
@SpringBootTest
class DriverDriverServiceImplTest {

    @Mock
    private DriverDao repository;
    private AutoCloseable autoCloseable;
    private DriverDriverServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new DriverDriverServiceImpl(repository);
    }
