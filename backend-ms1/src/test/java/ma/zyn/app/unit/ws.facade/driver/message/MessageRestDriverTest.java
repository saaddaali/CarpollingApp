...
import ma.zyn.app.ws.facade.driver.message.MessageRestDriver;
...
public class MessageRestDriverTest {

    private MockMvc mockMvc;

    @Mock
    private MessageDriverServiceImpl service;
    @Mock
    private MessageConverter converter;

    @InjectMocks
    private MessageRestDriver controller;
