package ma.zyn.app.unit.service.impl.driver.paiement;
...
@SpringBootTest
class CarteBancaireDriverServiceImplTest {

    @Mock
    private CarteBancaireDao repository;
    private AutoCloseable autoCloseable;
    private CarteBancaireDriverServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new CarteBancaireDriverServiceImpl(repository);
    }
