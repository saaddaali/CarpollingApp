package ma.zyn.app.unit.service.impl.admin.vehicule;
...
@SpringBootTest
class VehiculeAdminServiceImplTest {

    @Mock
    private VehiculeDao repository;
    private AutoCloseable autoCloseable;
    private VehiculeAdminServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new VehiculeAdminServiceImpl(repository);
    }
