package ma.zyn.app.unit.ws.facade.admin.driver;

import ma.zyn.app.bean.core.driver.Driver;
import ma.zyn.app.service.impl.admin.driver.DriverAdminServiceImpl;
import ma.zyn.app.ws.facade.admin.driver.DriverRestAdmin;
...
public class DriverRestAdminTest {

    private MockMvc mockMvc;

    @Mock
    private DriverAdminServiceImpl service;
    @Mock
    private DriverConverter converter;

    @InjectMocks
    private DriverRestAdmin controller;
