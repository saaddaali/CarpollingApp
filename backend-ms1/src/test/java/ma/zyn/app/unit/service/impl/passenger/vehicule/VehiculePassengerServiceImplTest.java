package ma.zyn.app.unit.service.impl.passenger.vehicule;
...
@SpringBootTest
class VehiculePassengerServiceImplTest {

    @Mock
    private VehiculeDao repository;
    private AutoCloseable autoCloseable;
    private VehiculePassengerServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new VehiculePassengerServiceImpl(repository);
    }
