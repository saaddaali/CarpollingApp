package ma.zyn.app.unit.ws.facade.passenger.passenger;
...
import ma.zyn.app.ws.facade.passenger.passenger.PassengerRestPassenger;
...
public class PassengerRestPassengerTest {

    private MockMvc mockMvc;

    @Mock
    private PassengerPassengerServiceImpl service;
    @Mock
    private PassengerConverter converter;

    @InjectMocks
    private PassengerRestPassenger controller;
