package ma.zyn.app.unit.ws.facade.driver.driver;

import ma.zyn.app.bean.core.driver.Driver;
import ma.zyn.app.service.impl.driver.driver.DriverDriverServiceImpl;
import ma.zyn.app.ws.facade.driver.driver.DriverRestDriver;
...
public class DriverRestDriverTest {

    private MockMvc mockMvc;

    @Mock
    private DriverDriverServiceImpl service;
    @Mock
    private DriverConverter converter;

    @InjectMocks
    private DriverRestDriver controller;
