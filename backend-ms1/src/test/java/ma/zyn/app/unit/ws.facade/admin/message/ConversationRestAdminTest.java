package ma.zyn.app.unit.ws.facade.admin.message;

import ma.zyn.app.bean.core.message.Conversation;
import ma.zyn.app.service.impl.admin.message.ConversationAdminServiceImpl;
import ma.zyn.app.ws.facade.admin.message.ConversationRestAdmin;
...
public class ConversationRestAdminTest {

    private MockMvc mockMvc;

    @Mock
    private ConversationAdminServiceImpl service;
    @Mock
    private ConversationConverter converter;

    @InjectMocks
    private ConversationRestAdmin controller;
