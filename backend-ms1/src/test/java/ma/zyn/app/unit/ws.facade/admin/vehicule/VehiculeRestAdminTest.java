package ma.zyn.app.unit.ws.facade.admin.vehicule;

import ma.zyn.app.bean.core.vehicule.Vehicule;
import ma.zyn.app.service.impl.admin.vehicule.VehiculeAdminServiceImpl;
import ma.zyn.app.ws.facade.admin.vehicule.VehiculeRestAdmin;
...
public class VehiculeRestAdminTest {

    private MockMvc mockMvc;

    @Mock
    private VehiculeAdminServiceImpl service;
    @Mock
    private VehiculeConverter converter;

    @InjectMocks
    private VehiculeRestAdmin controller;
