package ma.zyn.app.unit.service.impl.admin.driver;
...
@SpringBootTest
class DriverAdminServiceImplTest {

    @Mock
    private DriverDao repository;
    private AutoCloseable autoCloseable;
    private DriverAdminServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new DriverAdminServiceImpl(repository);
    }
