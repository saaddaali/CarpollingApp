package ma.zyn.app.unit.service.impl.admin.passenger;
...
@SpringBootTest
class PassengerAdminServiceImplTest {

    @Mock
    private PassengerDao repository;
    private AutoCloseable autoCloseable;
    private PassengerAdminServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new PassengerAdminServiceImpl(repository);
    }
