package ma.zyn.app.unit.ws.facade.admin.passenger;

import ma.zyn.app.bean.core.passenger.Passenger;
import ma.zyn.app.service.impl.admin.passenger.PassengerAdminServiceImpl;
import ma.zyn.app.ws.facade.admin.passenger.PassengerRestAdmin;
...
public class PassengerRestAdminTest {

    private MockMvc mockMvc;

    @Mock
    private PassengerAdminServiceImpl service;
    @Mock
    private PassengerConverter converter;

    @InjectMocks
    private PassengerRestAdmin controller;
