package ma.zyn.app.unit.service.impl.admin.trajet;
...
@SpringBootTest
class TrajetAdminServiceImplTest {

    @Mock
    private TrajetDao repository;
    private AutoCloseable autoCloseable;
    private TrajetAdminServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new TrajetAdminServiceImpl(repository);
    }
