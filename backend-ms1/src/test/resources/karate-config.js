function fn() {
    ...
    config.passengerUrl = config.adminUri + 'passenger/';
    config.villeUrl = config.adminUri + 'ville/';
    config.reservationUrl = config.adminUri + 'reservation/';
    config.trajetUrl = config.adminUri + 'trajet/';
    config.driverUrl = config.adminUri + 'driver/';
    config.messageUrl = config.adminUri + 'message/';
    config.carteBancaireUrl = config.adminUri + 'carteBancaire/';
    config.vehiculeUrl = config.adminUri + 'vehicule/';
