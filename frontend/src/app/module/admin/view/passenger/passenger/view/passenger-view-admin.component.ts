...
@Component({
  selector: 'app-passenger-view-admin',
  templateUrl: './passenger-view-admin.component.html'
})
export class PassengerViewAdminComponent implements OnInit {
    ...
    constructor(private service: PassengerAdminService, private carteBancaireService: CarteBancaireAdminService){
