...
@Component({
  selector: 'app-carte-bancaire-edit-admin',
  templateUrl: './carte-bancaire-edit-admin.component.html'
})
export class CarteBancaireEditAdminComponent implements OnInit {
