...
import {MessageAdminService} from 'src/app/shared/service/admin/message/MessageAdmin.service';
...
export class MessageListAdminComponent implements OnInit {
    ...
    constructor( private service: MessageAdminService  , private driverService: DriverAdminService, private passengerService: PassengerAdminService, private conversationService: ConversationAdminService, private trajetService: TrajetAdminService, @Inject(PLATFORM_ID) private platformId?) {
