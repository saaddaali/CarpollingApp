...
@Component({
  selector: 'app-conversation-list-admin',
  templateUrl: './conversation-list-admin.component.html'
})
export class ConversationListAdminComponent implements OnInit {

    protected fileName = 'Conversation';
    ...
    constructor( private service: ConversationAdminService  , private driverService: DriverAdminService, private passengerService: PassengerAdminService, @Inject(PLATFORM_ID) private platformId?) {
    ...
    public async view(dto: ConversationDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: ConversationDto) {
    ...
    public async duplicate(dto: ConversationDto) {
    ...
    public exportPdf(dto: ConversationDto): void {
...
// add
	...
	public initDuplicate(res: ConversationDto) {
	}
