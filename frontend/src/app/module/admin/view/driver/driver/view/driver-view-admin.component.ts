...
@Component({
  selector: 'app-driver-view-admin',
  templateUrl: './driver-view-admin.component.html'
})
export class DriverViewAdminComponent implements OnInit {
    ...
    constructor(private service: DriverAdminService){
