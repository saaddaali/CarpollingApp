...
@Component({
  selector: 'app-trajet-view-admin',
  templateUrl: './trajet-view-admin.component.html'
})
export class TrajetViewAdminComponent implements OnInit {
    ...
    constructor(private service: TrajetAdminService, private driverService: DriverAdminService, private villeService: VilleAdminService){
