...
@Component({
  ...
  templateUrl: './model-permission-user-edit.component.html'
})
export class ModelPermissionUserEditComponent extends AbstractEditController<ModelPermissionUserDto, ModelPermissionUserCriteria, ModelPermissionUserService>   implements OnInit {
