...
@Component({
  selector: 'app-reservation-edit-passenger',
  templateUrl: './reservation-edit-passenger.component.html'
})
export class ReservationEditPassengerComponent implements OnInit {
    ...
    public prepareEdit() {
        this.item.dateReservation = this.service.format(this.item.dateReservation);
