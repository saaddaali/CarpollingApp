...
@Component({
  selector: 'app-passenger-list-passenger',
  templateUrl: './passenger-list-passenger.component.html'
})
export class PassengerListPassengerComponent implements OnInit {

    protected fileName = 'Passenger';
    ...
    constructor( private service: PassengerPassengerService  , private carteBancaireService: CarteBancairePassengerService, @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<PassengerDto>();
    ...
    public async edit(dto: PassengerDto) {
    ...
    public async view(dto: PassengerDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: PassengerDto) {
    ...
    public async duplicate(dto: PassengerDto) {
    ...
    public exportPdf(dto: PassengerDto): void {
...
// add
	...
	public initDuplicate(res: PassengerDto) {
	}
    ...
    get selections(): Array<PassengerDto> {
        return this.service.selections;
    }

    set selections(value: Array<PassengerDto>) {
