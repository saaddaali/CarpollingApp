...
@Component({
  selector: 'app-passenger-create-passenger',
  templateUrl: './passenger-create-passenger.component.html'
})
export class PassengerCreatePassengerComponent  implements OnInit {
