...
@Component({
  selector: 'app-ville-list-passenger',
  templateUrl: './ville-list-passenger.component.html'
})
export class VilleListPassengerComponent implements OnInit {

    protected fileName = 'Ville';
    ...
    constructor( private service: VillePassengerService  , @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<VilleDto>();
    ...
    public async edit(dto: VilleDto) {
    ...
    public async view(dto: VilleDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: VilleDto) {
    ...
    public async duplicate(dto: VilleDto) {
    ...
    public exportPdf(dto: VilleDto): void {
...
// add
    ...
    get selections(): Array<VilleDto> {
        return this.service.selections;
    }

    set selections(value: Array<VilleDto>) {
