...
@Component({
  selector: 'app-ville-view-passenger',
  templateUrl: './ville-view-passenger.component.html'
})
export class VilleViewPassengerComponent implements OnInit {
    ...
    constructor(private service: VillePassengerService){
