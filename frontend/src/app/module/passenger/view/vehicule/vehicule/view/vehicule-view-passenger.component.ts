...
@Component({
  selector: 'app-vehicule-view-passenger',
  templateUrl: './vehicule-view-passenger.component.html'
})
export class VehiculeViewPassengerComponent implements OnInit {
    ...
    constructor(private service: VehiculePassengerService, private driverService: DriverPassengerService){
