...
@Component({
  selector: 'app-carte-bancaire-edit-passenger',
  templateUrl: './carte-bancaire-edit-passenger.component.html'
})
export class CarteBancaireEditPassengerComponent implements OnInit {
    ...
    public prepareEdit() {
        this.item.dateExpiration = this.service.format(this.item.dateExpiration);
    }
