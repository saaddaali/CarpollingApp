...
@Component({
  selector: 'app-carte-bancaire-create-passenger',
  templateUrl: './carte-bancaire-create-passenger.component.html'
})
export class CarteBancaireCreatePassengerComponent  implements OnInit {
