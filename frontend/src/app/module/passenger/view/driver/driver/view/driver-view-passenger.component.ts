...
@Component({
  selector: 'app-driver-view-passenger',
  templateUrl: './driver-view-passenger.component.html'
})
export class DriverViewPassengerComponent implements OnInit {
    ...
    constructor(private service: DriverPassengerService){
