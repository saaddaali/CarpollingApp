...
@Component({
  selector: 'app-conversation-list-passenger',
  templateUrl: './conversation-list-passenger.component.html'
})
export class ConversationListPassengerComponent implements OnInit {
