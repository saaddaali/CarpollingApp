...
@Component({
  selector: 'app-message-view-passenger',
  templateUrl: './message-view-passenger.component.html'
})
export class MessageViewPassengerComponent implements OnInit {
    ...
    constructor(private service: MessagePassengerService, private driverService: DriverPassengerService, private passengerService: PassengerPassengerService, private conversationService: ConversationPassengerService, private trajetService: TrajetPassengerService){
