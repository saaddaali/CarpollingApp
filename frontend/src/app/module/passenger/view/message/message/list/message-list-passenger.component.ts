...
import {MessagePassengerService} from 'src/app/shared/service/passenger/message/MessagePassenger.service';
...
@Component({
  selector: 'app-message-list-passenger',
  templateUrl: './message-list-passenger.component.html'
})
export class MessageListPassengerComponent implements OnInit {

    protected fileName = 'Message';
    ...
    constructor( private service: MessagePassengerService  , private driverService: DriverPassengerService, private passengerService: PassengerPassengerService, private conversationService: ConversationPassengerService, private trajetService: TrajetPassengerService, @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<MessageDto>();
    ...
    public async edit(dto: MessageDto) {
    ...
    public async view(dto: MessageDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: MessageDto) {
    ...
    public async duplicate(dto: MessageDto) {
    ...
    public exportPdf(dto: MessageDto): void {
...
// add
    ...
    get selections(): Array<MessageDto> {
        return this.service.selections;
    }

    set selections(value: Array<MessageDto>) {
