...
@Component({
    selector: 'app-forget-password-passenger',
    templateUrl: './forget-password-passenger.component.html',
    styleUrls: ['./forget-password-passenger.component.css'],
})
export class ForgetPasswordPassengerComponent {
    ...
    submit() {
        this.authService.sendForgetPasswordActivation(this.forgetPasswordDto.email).subscribe({
            next: () => {
                ...
                this.router.navigate(['passenger/changePassword'])
            },
