...
@Component({
  selector: 'app-change-password-passenger',
  templateUrl: './change-password-passenger.component.html',
  styleUrls: ['./change-password-passenger.component.css']
})
export class ChangePasswordPassengerComponent implements OnInit {
