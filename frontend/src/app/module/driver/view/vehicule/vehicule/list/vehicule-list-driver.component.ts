...
import {VehiculeDriverService} from 'src/app/shared/service/driver/vehicule/VehiculeDriver.service';
...
@Component({
  selector: 'app-vehicule-list-driver',
  templateUrl: './vehicule-list-driver.component.html'
})
export class VehiculeListDriverComponent implements OnInit {

    protected fileName = 'Vehicule';
    ...
    constructor( private service: VehiculeDriverService  , private driverService: DriverDriverService, @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<VehiculeDto>();
    ...
    public async edit(dto: VehiculeDto) {
    ...
    public async view(dto: VehiculeDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: VehiculeDto) {
    ...
    public async duplicate(dto: VehiculeDto) {
    ...
    public exportPdf(dto: VehiculeDto): void {
...
// add
    ...
    public initCol() {
        this.cols = [
            ...
            {field: 'plaqueImmatriculation', header: 'Plaque immatriculation'},
	...
	public initDuplicate(res: VehiculeDto) {
	}
    ...
    public prepareColumnExport(): void {
        this.service.findByCriteria(this.criteria).subscribe(
            (allItems) =>{
                this.exportData = allItems.map(e => {
					return {
						...
						'Annee': e.annee ,
						'Couleur': e.couleur ,
						'Plaque immatriculation': e.plaqueImmatriculation ,
						'Capacite': e.capacite ,
						'Image': e.image ,
					}
				});
            ...
            //'Driver': this.criteria.driver?.email ? this.criteria.driver?.email : environment.emptyForExport ,
                'Marque': this.criteria.marque ? this.criteria.marque : environment.emptyForExport ,
                'Modele': this.criteria.modele ? this.criteria.modele : environment.emptyForExport ,
                ...
                'Plaque immatriculation': this.criteria.plaqueImmatriculation ? this.criteria.plaqueImmatriculation : environment.emptyForExport ,
                'Capacite Min': this.criteria.capaciteMin ? this.criteria.capaciteMin : environment.emptyForExport ,
                'Capacite Max': this.criteria.capaciteMax ? this.criteria.capaciteMax : environment.emptyForExport ,
    ...
    get selections(): Array<VehiculeDto> {
        return this.service.selections;
    }

    set selections(value: Array<VehiculeDto>) {
