...
@Component({
  selector: 'app-vehicule-view-driver',
  templateUrl: './vehicule-view-driver.component.html'
})
export class VehiculeViewDriverComponent implements OnInit {
    ...
    constructor(private service: VehiculeDriverService, private driverService: DriverDriverService){
