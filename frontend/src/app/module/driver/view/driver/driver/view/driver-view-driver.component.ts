...
@Component({
  selector: 'app-driver-view-driver',
  templateUrl: './driver-view-driver.component.html'
})
export class DriverViewDriverComponent implements OnInit {
    ...
    constructor(private service: DriverDriverService){
