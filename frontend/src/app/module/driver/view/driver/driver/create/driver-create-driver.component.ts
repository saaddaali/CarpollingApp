...
@Component({
  selector: 'app-driver-create-driver',
  templateUrl: './driver-create-driver.component.html'
})
export class DriverCreateDriverComponent  implements OnInit {
	...
	constructor(private service: DriverDriverService , @Inject(PLATFORM_ID) private platformId? ) {
