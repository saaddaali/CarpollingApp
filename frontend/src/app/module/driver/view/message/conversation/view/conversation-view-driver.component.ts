...
@Component({
  selector: 'app-conversation-view-driver',
  templateUrl: './conversation-view-driver.component.html'
})
export class ConversationViewDriverComponent implements OnInit {
    ...
    constructor(private service: ConversationDriverService, private driverService: DriverDriverService, private passengerService: PassengerDriverService){
