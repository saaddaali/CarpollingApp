...
@Component({
  selector: 'app-passenger-view-driver',
  templateUrl: './passenger-view-driver.component.html'
})
export class PassengerViewDriverComponent implements OnInit {
    ...
    constructor(private service: PassengerDriverService, private carteBancaireService: CarteBancaireDriverService){
