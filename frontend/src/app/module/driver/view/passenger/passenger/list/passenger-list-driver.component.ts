...
@Component({
  selector: 'app-passenger-list-driver',
  templateUrl: './passenger-list-driver.component.html'
})
export class PassengerListDriverComponent implements OnInit {
    ...
    constructor( private service: PassengerDriverService  , private carteBancaireService: CarteBancaireDriverService, @Inject(PLATFORM_ID) private platformId?) {
