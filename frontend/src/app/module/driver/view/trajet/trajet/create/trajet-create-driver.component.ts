...
@Component({
  selector: 'app-trajet-create-driver',
  templateUrl: './trajet-create-driver.component.html'
})
export class TrajetCreateDriverComponent  implements OnInit {
	...
	constructor(private service: TrajetDriverService , private driverService: DriverDriverService, private villeService: VilleDriverService, @Inject(PLATFORM_ID) private platformId? ) {
