...
@Component({
  selector: 'app-ville-view-driver',
  templateUrl: './ville-view-driver.component.html'
})
export class VilleViewDriverComponent implements OnInit {
    ...
    constructor(private service: VilleDriverService){
