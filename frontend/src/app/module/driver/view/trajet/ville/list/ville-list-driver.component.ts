...
@Component({
  selector: 'app-ville-list-driver',
  templateUrl: './ville-list-driver.component.html'
})
export class VilleListDriverComponent implements OnInit {
    ...
    constructor( private service: VilleDriverService  , @Inject(PLATFORM_ID) private platformId?) {
