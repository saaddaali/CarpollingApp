...
@Component({
    selector: 'app-forget-password-driver',
    templateUrl: './forget-password-driver.component.html',
    styleUrls: ['./forget-password-driver.component.css'],
})
export class ForgetPasswordDriverComponent {
    ...
    submit() {
        this.authService.sendForgetPasswordActivation(this.forgetPasswordDto.email).subscribe({
            next: () => {
                ...
                this.router.navigate(['driver/changePassword'])
            },
