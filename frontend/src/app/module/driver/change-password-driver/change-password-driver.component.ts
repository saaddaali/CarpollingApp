...
@Component({
  selector: 'app-change-password-driver',
  templateUrl: './change-password-driver.component.html',
  styleUrls: ['./change-password-driver.component.css']
})
export class ChangePasswordDriverComponent implements OnInit {
    ...
    forgetPassword() {
        this.router.navigate(['/driver/forget-password'])
    }
